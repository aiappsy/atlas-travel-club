                ...
                <div>
                  <div className="relative h-64 overflow-hidden">
                    <img
                      ...
                      alt={yacht.name}
                      onError={(e) => {
                        e.currentTarget.src = 'https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?auto=format&fit=crop&w=1200&q=80';
                      }}
                ...
                <div>
                  <div className="relative h-56 overflow-hidden">
                    <img
                      ...
                      alt={car.makeModel}
                      onError={(e) => {
                        e.currentTarget.src = 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&w=1200&q=80';
                      }}
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                    />
                    <div className="absolute top-3 left-3 bg-slate-950/80 backdrop-blur-md text-white text-xs font-black px-3 py-1 rounded-full shadow border border-white/10">
